...
// ===================================================================================
// --- COMPONENTS: These components now use the data defined above. ---
// ===================================================================================
                ...
                {testimonialsData.map(t => (
                    <div key={t.id} className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-lg">
                        ...
                        <div className="flex items-center">
                            <img className="h-12 w-12 rounded-full object-cover mr-4" src={t.avatar} alt={t.name} onError={(e) => { e.target.src = 'https://placehold.co/48x48/EBF4FF/76A9FA?text=IM'; }} />
                            <div>
