...
const LabsPage = () => {
  return (
    <div className="max-w-7xl mx-auto py-16 px-4">
      ...
      <p className="text-center text-lg text-gray-600 dark:text-gray-300 mb-12">Hands-on practical exercises and simulations to apply your knowledge.</p>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {labsData.map(lab => (
          <div key={lab.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            ...
            <p className="text-gray-600 dark:text-gray-300">{lab.description}</p>
          </div>
        ))}
      </div>
    </div>
